...
//        objectMapper.setSerializationInclusion(JsonSerialize.Inclusion.NON_EMPTY);
    ...
    public static boolean checkJSONEmpty(String jsonStr){
        if(Strings.isNotBlank(jsonStr) && jsonStr.startsWith("[")){
            JSONArray jsonArray = JSONArray.parseArray(jsonStr);
            return jsonArray.isEmpty();
        } else if(Strings.isNotBlank(jsonStr) && jsonStr.startsWith("{")){
    ...
    public Triplet validate(){
        return new Triplet(false,"errCode","msg");
    }
}
